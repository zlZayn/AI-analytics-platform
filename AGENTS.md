...
- vitest: 48 files / 257 passed / 0 failed；typecheck / lint: 0 errors
...
## 待办
- [ ] 联网人工验收 R 图像输出与历史回放（`captureGraphics`、`injecting` 离线不可验）：[docs/verification.md](docs/verification.md) 第 5 节
